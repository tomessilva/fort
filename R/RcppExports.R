...
#' @noRd
.FORT_CPP_FFT1_fwd <- function(X_Re, X_Im, s1, s2, s3, s4) {
    .Call(`_fort_FORT_CPP_FFT1_fwd`, X_Re, X_Im, s1, s2, s3, s4)
}
...
#' @return transformed numeric matrix
#' @noRd
.FORT_CPP_FFT1_rev <- function(X_Re, X_Im, s1, s2, s3, s4) {
    .Call(`_fort_FORT_CPP_FFT1_rev`, X_Re, X_Im, s1, s2, s3, s4)
}
