#
# fort package - FastTransformFFT2 class definition ----
#
...
#'
#' @export
FastTransformFFT2 <- R6::R6Class(classname="FastTransformFFT2",
                                 ...
                                 public=list(
                                   ...
                                   initialize=function(dim_in,dim_out,blocksize) {
                                     ...
                                     # define complex scaling parameters - cs1, cs2, cs3
                                     ...
                                     cs3 <- complex(modulus = 1,
                                                    argument = 2 * pi * runif(nn)) * overall_scaling_factor
                                     out_list[["cs1_re"]] <- Re(cs1)
                                     out_list[["cs1_im"]] <- Im(cs1)
                                     out_list[["cs2_re"]] <- Re(cs2)
                                     out_list[["cs2_im"]] <- Im(cs2)
                                     out_list[["cs3_re"]] <- Re(cs3)
                                     out_list[["cs3_im"]] <- Im(cs3)
                                   ...
                                   fwd_eval=function(x) {
                                     ...
                                     Xout <- .Call(`_fort_FORT_CPP_FFT2_fwd`,
                                                   # X_Re, X_Im
                                                   X1,X2,
                                                   # s1, s2, s3, s4, s5, s6
                                                   p_[["cs1_re"]],p_[["cs1_im"]],
                                   ...
                                   calculate_rev_par=function() {
                                     ...
                                     #  * p1_re, p1_im
                                     #  * cs1_re, cs1_im, cs2_re, cs2_im, cs3_re, cs3_im
                                     #  * p2
                                     # inverse has nine parameters:
                                     #  * p2i_re, p2i_im
                                     #  * cs3i_re, cs3i_im, cs2i_re, cs2i_im, cs1i_re, cs1i_im
                                     #  * p1i
                                     ...
                                     self$rev_par <- list(p2i_re = p2i_re, p2i_im = p2i_im,
                                                          cs3i_re = Re(cs3i), cs3i_im = Im(cs3i),
